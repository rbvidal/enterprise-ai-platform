...
Twenty ADRs document every major decision. Each follows the standard format adopted by the project: Context, Decision, Alternatives, Consequences, Trade-offs, Future Evolution.
